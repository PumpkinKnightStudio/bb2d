...
summon area_effect_cloud ~ ~ ~ {Tags:["nexus.launch"],WaitTime:0,Duration:1,Age:-1,Radius:0.0f,ReapplicationDelay:-1,effects:[{id:"minecraft:instant_damage",amplifier:0b,duration:1}]}
