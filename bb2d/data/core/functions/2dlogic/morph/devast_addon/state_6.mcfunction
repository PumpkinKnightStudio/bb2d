...
execute as @s[team=left] run scoreboard players operation @e[tag=unset,tag=spawn_dsphear,tag=left,limit=1] damagerID = @s playerID
execute as @s[team=right] run scoreboard players operation @e[tag=unset,tag=spawn_dsphear,tag=right,limit=1] damagerID = @s playerID
