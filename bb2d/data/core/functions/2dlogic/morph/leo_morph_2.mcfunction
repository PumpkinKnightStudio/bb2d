...
execute if score @s animate matches 0 run execute if score @s walking matches 0 run item replace entity @s armor.head with minecraft:potion{CustomModelData:800601}
execute if score @s animate matches 0 run execute if score @s[type=player] walking matches 1.. run scoreboard players add @s leo.walkTime 1
execute if score @s leo.walkTime matches 1..20 run execute if score @s animate matches 0 run execute if score @s walking matches 1.. run item replace entity @s armor.head with minecraft:potion{CustomModelData:800602}
execute if score @s leo.walkTime matches 21.. run execute if score @s animCooldown matches 0 run execute if score @s walking matches 1.. run item replace entity @s armor.head with minecraft:potion{CustomModelData:800610}
execute if score @s[type=player] walking matches 0 run scoreboard players set @s leo.walkTime 0
...
execute if score @s leo.walkTime matches 21.. run execute if score @s[type=armor_stand,tag=model] animate matches 0 run execute if score @s animCooldown matches 0 run execute if score @s walking matches 1.. run item replace entity @s armor.head with minecraft:potion{CustomModelData:800610}

## THIS LINE BELOW PATCH SOME DEFAULT ATTACK ANIMATION BUG
execute if score @s leo.walkTime matches 0 run execute if score @s[type=armor_stand,tag=model] animate matches 0 run execute if score @s animCooldown matches 0 run execute if score @s walking matches 1.. run item replace entity @s armor.head with minecraft:potion{CustomModelData:800602}
