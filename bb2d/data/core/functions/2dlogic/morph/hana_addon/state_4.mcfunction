scoreboard players set @s dealingDMG 25
...
execute as @s[team=left,scores={lookingDir=1}] at @s run execute positioned ~ ~ ~-1 run scoreboard players set @a[team=right,distance=0..3] motionBack 1

execute as @s[team=right,scores={lookingDir=1}] at @s run execute positioned ~ ~ ~-1 run scoreboard players set @a[team=left,distance=0..3] motionBack 1

execute as @s[team=left,scores={lookingDir=2}] at @s run execute positioned ~ ~ ~1 run scoreboard players set @a[team=right,distance=0..3] motionBack -1

execute as @s[team=right,scores={lookingDir=2}] at @s run execute positioned ~ ~ ~1 run scoreboard players set @a[team=left,distance=0..3] motionBack -1

execute as @s[team=left,scores={lookingDir=1}] at @s run execute positioned ~ ~ ~-1 run scoreboard players set @a[team=right,distance=0..3] motionY 1000

execute as @s[team=right,scores={lookingDir=1}] at @s run execute positioned ~ ~ ~-1 run scoreboard players set @a[team=left,distance=0..3] motionY 1000

execute as @s[team=left,scores={lookingDir=2}] at @s run execute positioned ~ ~ ~1 run scoreboard players set @a[team=right,distance=0..3] motionY 1000

execute as @s[team=right,scores={lookingDir=2}] at @s run execute positioned ~ ~ ~1 run scoreboard players set @a[team=left,distance=0..3] motionY 1000
