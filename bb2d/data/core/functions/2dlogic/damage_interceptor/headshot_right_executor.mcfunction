...
execute as @s[type=armor_stand] at @s run scoreboard players add @s[team=left,type=armor_stand,scores={impactCooldown=8..}] impactCooldown 15

execute as @s[type=armor_stand] at @s run scoreboard players set @s[team=left,type=armor_stand,scores={impactCooldown=..-1}] impactCooldown 15